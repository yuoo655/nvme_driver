...
pub(crate) struct NvmeQueue<D: DmaAllocator, I: IrqController> {
...
impl<D: DmaAllocator, I: IrqController> NvmeQueue<D, I> {
    pub(crate) fn new(
        // data: Ref<DeviceData>,
        qid: u16, 
        depth: u16, 
        ...
        let cq: DmaInfo<NvmeCompletion> = dma_alloc::<NvmeCompletion,D>(depth.into());
        let sq: DmaInfo<NvmeCommand> = dma_alloc::<NvmeCommand, D>(depth.into());
